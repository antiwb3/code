...
void QtProperty::setUserData(void *data)
{
	m_userData = data;
}

void *QtProperty::getUserData()
{
	return m_userData;
}

void QtProperty::setCollapsed(int bcollapsed)
{
	m_bcollapsed = bcollapsed;
}

int QtProperty::isCollapsed()
{
	return m_bcollapsed;
}
/*!
        ...
        QtBrowserItem *parentIndex, QtBrowserItem *afterIndex)
{
    ...
    {
        q_ptr->collapseItem(newIndex);
    }
    else
    {
        q_ptr->expandItem(newIndex);
    }
...
void QtAbstractPropertyBrowser::expandItem(const QtBrowserItem *item)
{

}

void QtAbstractPropertyBrowser::collapseItem(const QtBrowserItem *item)
{
