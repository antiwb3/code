...
class QtStringMgrEditorFactoryPrivate;

class QT_QTPROPERTYBROWSER_EXPORT QtStringMgrEditorFactory : public QtAbstractEditorFactory<QtStringPropertyManager>
{
    Q_OBJECT
public:
    QtStringMgrEditorFactory(QObject *parent = 0);
    ~QtStringMgrEditorFactory();
protected:
    void connectPropertyManager(QtStringPropertyManager *manager);
    QWidget *createEditor(QtStringPropertyManager *manager, QtProperty *property,
        QWidget *parent);
    void disconnectPropertyManager(QtStringPropertyManager *manager);
private:
    QtStringMgrEditorFactoryPrivate *d_ptr;
    Q_DECLARE_PRIVATE(QtStringMgrEditorFactory)
        Q_DISABLE_COPY(QtStringMgrEditorFactory)
        Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, const QString &))
        Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
        Q_PRIVATE_SLOT(d_func(), void slotSetValue(const QString &))
};
...
class QtInputEditorFactoryPrivate;

class QT_QTPROPERTYBROWSER_EXPORT QtInputEditorFactory : public QtAbstractEditorFactory<QtStringPropertyManager>
{
	Q_OBJECT
public:
	QtInputEditorFactory(QObject *parent = 0);
	~QtInputEditorFactory();
protected:
	void connectPropertyManager(QtStringPropertyManager *manager);
	QWidget *createEditor(QtStringPropertyManager *manager, QtProperty *property,
		QWidget *parent);
	void disconnectPropertyManager(QtStringPropertyManager *manager);
private:
	QtInputEditorFactoryPrivate *d_ptr;
	Q_DECLARE_PRIVATE(QtInputEditorFactory)
		Q_DISABLE_COPY(QtInputEditorFactory)
		Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, const QString &))
		Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
		Q_PRIVATE_SLOT(d_func(), void slotSetValue(const QString &))
};

class QtButtonEditorFactoryPrivate;

class QT_QTPROPERTYBROWSER_EXPORT QtButtonEditorFactory : public QtAbstractEditorFactory<QtStringPropertyManager>
{
	Q_OBJECT
public:
	QtButtonEditorFactory(QObject *parent = 0);
	~QtButtonEditorFactory();
protected:
	void connectPropertyManager(QtStringPropertyManager *manager);
	QWidget *createEditor(QtStringPropertyManager *manager, QtProperty *property,
		QWidget *parent);
	void disconnectPropertyManager(QtStringPropertyManager *manager);
private:
	QtButtonEditorFactoryPrivate *d_ptr;
	Q_DECLARE_PRIVATE(QtButtonEditorFactory)
		Q_DISABLE_COPY(QtButtonEditorFactory)
		Q_PRIVATE_SLOT(d_func(), void slotPropertyChanged(QtProperty *, const QString &))
		Q_PRIVATE_SLOT(d_func(), void slotEditorDestroyed(QObject *))
		Q_PRIVATE_SLOT(d_func(), void slotSetValue(const QString &))
};
