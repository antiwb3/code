...
public :
	void expandItem(const QtBrowserItem *item);
	void collapseItem(const QtBrowserItem *item);
...
void QtTreePropertyBrowserPrivate::expandItem(const QtBrowserItem *item)
{
	QTreeWidgetItem *widgetItem = m_indexToItem.value((QtBrowserItem *)item);
	m_treeWidget->expandItem(widgetItem);
}

void QtTreePropertyBrowserPrivate::collapseItem(const QtBrowserItem *item)
{
	QTreeWidgetItem *widgetItem = m_indexToItem.value((QtBrowserItem *)item);
	m_treeWidget->collapseItem(widgetItem);
}
...
void QtTreePropertyBrowser::expandItem(const QtBrowserItem *item)
{
	d_ptr->expandItem(item);
}

void QtTreePropertyBrowser::collapseItem(const QtBrowserItem *item)
{
	d_ptr->collapseItem(item);
}
